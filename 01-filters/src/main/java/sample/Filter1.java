...
public class Filter1 extends OncePerRequestFilter {
	private static final String INVOKED_ATTR = Filter1.class.getName().concat(".INVOKED_ATTR");
	private static final String DO_NOT_CONTINUE_ATTR = Filter1.class.getName().concat(".DISABLED_ATTR");
